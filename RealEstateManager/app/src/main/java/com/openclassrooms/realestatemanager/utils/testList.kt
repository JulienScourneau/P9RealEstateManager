...
object TestList {
    ...
    private val estateList = mutableListOf(
        ...
        Estate(3,photosHouse, "Fake Category 4", "990 000 €", "Fake_Description", 800, 9, 2, 3, address),
        Estate(4,photosApartment, "Fake_category 5", "550 000 €", "Fake Description", 600, 8, 1, 2, address),
        Estate(5,photosHouse, "Fake Category 6", "650 000 €", "Fake_Description", 800, 9, 2, 3, address),
        Estate(6,photosApartment, "Fake_category 7", "500 000 €", "Fake Description", 600, 8, 1, 2, address),
        Estate(7,photosHouse, "Fake Category 8", "900 000 €", "Fake_Description", 800, 9, 2, 3, address)
